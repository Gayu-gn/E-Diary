...
<div class="content">
  <div style="font-size: 40px; font-weight: bold;">Manage Category</div><br><br>
  <table class="table table-bordered">
                            ...
                            <tbody>
                              <?php 
                                $con = mysqli_connect("localhost","root","","ediary");
                                  $e=$_SESSION['e'];
                                  ...
                                  {       
                                    while ($row=mysqli_fetch_assoc($query_run)) {
                                      ...
                                      <td>'.$date.'</td>
                                      <td>
                                      <button class="btn"><a href="deletec.php?deleteid='.$sno.'" style="text-decoration: none; background-color: #de9bd9; color:white; padding:3px;">DELETE</a></button>
                                      </td> 
                                      </tr>';
                                    }
                                  }       
