...
$q="select * from registration where email_id='$e' ";
...
<div class="content">
    <div style="font-size: 40px; font-weight: bold;">Profile</div><br><br>
    <div class="container-fluid">
    <form class="col p-5" method="POST" >
        <div class="row">
            <div class="col">
                <label>FirstName</label><br><br>
                <input class="col-9" type="text" name="firstname" value="<?php echo $firstname; ?>">
            </div>
            <div class="col">
                <label>LastName</label><br><br>
                <input class="col-9" type="text" name="lastname" value="<?php echo $lastname; ?>">
            </div>
        </div><br><br>
        <div class="row">
            <div class="col">
                <label>Phone Number</label><br><br>
                <input class="col-9" type="number" name="phoneno" value="<?php echo $phoneno; ?>">
            </div>
            <div class="col">
                <label>City</label><br><br>
                <input class="col-9" type="text" name="city" value="<?php echo $city; ?>">
            </div>
        </div><br><br>
        <div class="row">
            <div class="col">
                <label>Email ID</label><br><br>
                <input class="col-11" type="text" name="email_id" value="<?php echo $email_id; ?>">
            </div>
        </div><br><br>
        <button type="submit" style="color: white; background-color: #9d6aba; " name="submit" class="btn btn-md btn-block text-uppercase">UPDATE</button>
    </form>
</div>
</div>
</body>
...
$e=$_SESSION['e'];
    ...
    $q="update registration set firstname='$firstname1',lastname='$lastname1',phoneno='$phoneno1',email_id='$email_id1',city='$city1' where email_id='$e' " ;
    $r=mysqli_query($conn,$q);
    if($r){
