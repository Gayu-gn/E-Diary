...
<div class="content">
  <div style="font-size: 40px; font-weight: bold;">Dashboard</div><br><br>
    <div>
      <p style="background-color: #de9bd9; padding: 20px; font-size: 20px;">Total Category || <?php
    ...
    <div>
      <p style="background-color: #de9bd9; padding: 20px; font-size: 20px;">Total Notes || <?php
                        $conn=mysqli_connect("localhost","root","","ediary");
