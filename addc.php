...
<div class="content">
  <div style="font-size: 40px; font-weight: bold;">Add Category</div><br><br>
  <div class="container-fluid col-12">   
    <form method="POST" class="p-3">
      <label style="font-size: 30px; font-weight: lighter; font-style: italic;">Category Name</label><br><br>
      <input type="text" name="category" class="col-9" placeholder="Your Category Name..."><br><br>      <button type="submit" style="color: white; background-color: #9d6aba; " name="submit" class="btn btn-md btn-block text-uppercase">Submit</button>
    </form>
  </div>
</div>
</body>
...
if(isset($_POST['submit'])){
  ...
  $q="insert into category (email_id,category,date) values ('$e','$category','$date') ";
