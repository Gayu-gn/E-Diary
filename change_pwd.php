...
<div class="content">
  <div style="font-size: 40px; font-weight: bold;">Change Password</div><br><br>
  <div class="container-fluid col-6">   
    <form method="POST" class="p-5">
      <label style="font-size: 15px;">Old Password</label><br><br>
      <input type="number" name="oldpassword" class="col-6" placeholder="Old Password..."><br><br>
      <label style="font-size: 15px;">New Password</label><br><br>
      <input type="number" name="passwordnew" class="col-6" placeholder="Old Password..."><br><br>      
      <label style="font-size: 15px;">Confrim Password</label><br><br>
      <input type="number" name="passwordc" class="col-6" placeholder="Old Password..."><br><br>
      <button type="submit" style="color: white; background-color: #9d6aba; " name="submit" class="btn btn-md btn-block text-uppercase">Submit</button>
    </form>
  </div>
</div>
</body>
...
$q="select * from registration where password='$p' ";
...
if($oldpassword == $pass) 
{
  ...
  {    
      $q="update registration set password='$passwordc' where password='$pass' ";
      $r=mysqli_query($conn,$q);
      if($r){
        echo "<script>alert('Successfully Updated!'); </script>";
      }
      else{
        echo "<script>alert('Not Updated check out your password!'); </script>";
      }
  }
} 
else 
