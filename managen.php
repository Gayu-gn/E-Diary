...
<div class="content">
  <div style="font-size: 40px; font-weight: bold;">Manage Notes</div><br><br>
  <table class="table table-bordered">
                            <th>
                                <tr style="background-color: #de9bd9;">
                                    <th>SNO</th>
                                    <th>CATEGORY NAME</th>
                                    <th>TITLE</th>
                                    <TH>DESCRIPTION</TH>
                            ...
                            <tbody>
                              <?php 
                                $conn = mysqli_connect("localhost","root","","ediary");
                                  $e=$_SESSION['e'];
                                  $query = "SELECT * FROM notes where email_id='$e' ";
                                  ...
                                  {       
                                    while ($row=mysqli_fetch_assoc($query_run)) {
                                      ...
                                      <td>'.$cdate.'</td>
                                      <td>
                                      <button class="btn"><a href="viewn.php?viewid='.$sno.'" style="text-decoration: none; background-color: #de9bd9; color:white; padding:5px;">VIEW</a></button>
                                      <button class="btn"><a href="deleten.php?deleteid='.$sno.'" style="text-decoration: none; background-color: #de9bd9; color:white; padding:5px;">DELETE</a></button>
                                      </td> 
                                      </tr>';
                                    }
                                  }       
