...
<div class="content">
  ...
  <div class="container-fluid col-9">   
    <form method="POST" class="p-3">
      ...
      <select class="form-select col-md-6" name="category_name">
        <option selected>Select Category</option>
          <?php
            ...
            $e=$_SESSION['e'];
            $query = "SELECT * FROM category where email_id='$e' ";
      ...
      <input type="text" name="title" class="col-12" placeholder="Your Note Title..."><br><br>
      <label style="font-size: 20px;">Note Description</label><br>
      <textarea rows="8" cols="109" name="description" placeholder="Your Note Description..."></textarea>
      <br><br>      <button type="submit" style="color: white; background-color: #9d6aba; " name="submit" class="btn btn-md btn-block text-uppercase">Submit</button>
    </form>
  </div>
</div>
</body>
...
if(isset($_POST['submit'])){
  ...
  $conn=mysqli_connect("localhost","root","","ediary");
  $q="insert into notes (email_id,cdate,category_name,title,description) values ('$e','$cdate','$category_name','$title','$description') ";
